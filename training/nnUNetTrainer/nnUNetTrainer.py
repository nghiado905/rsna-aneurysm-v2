...
class nnUNetTrainer(object):
    ...
    def on_epoch_end(self):
        ...
        if np.isnan(current_val_loss):
            ...
            self.print_to_log_file('val_loss', np.round(current_val_loss, decimals=4))
        ...
        if not np.isnan(current_ema) and (self._best_ema is None or current_ema > self._best_ema):
    ...
    def run_training(self):
        ...
        for epoch in range(self.current_epoch, self.num_epochs):
            ...
            if should_validate:
                ...
                self.logger.log('dice_per_class_or_region', [np.nan, np.nan], self.current_epoch)
